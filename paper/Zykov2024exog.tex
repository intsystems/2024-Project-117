...
\title
    [Предсказание нейронной активности с экзогенными факторами] % краткое название; не нужно, если полное название влезает в~колонтитул
...
\author
    ...
    [Зыков~Т.А.$^1$, Дорин~Д.Д.$^2$, Тихонов~Д.М.$^{1, 2}$] % список авторов, выводимый в заголовок; не нужен, если он не отличается от основного
\email
